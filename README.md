...
All environment variables are optional and have sensible default values.
...
| `SIMPLE_RESOLVERS_LIST` | Instead of getting the public resolvers list from a host name, just use this list instead, SEMI-COLON separate list of IP Addresses | None
